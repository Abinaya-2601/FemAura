...
<body data-bs-spy="scroll" data-bs-target=".navbar" data-bs-offset="100">
  ...
  <div class="buttons-div mt-5">
    <button class= "sosbutton" onclick="playAudio()" type="button">SOS Alert</button>
    <button class="stopbutton" onclick="pauseAudio()" type="button">Stop Alert</button>
  </div>
  <!-- Navbar section exit -->
